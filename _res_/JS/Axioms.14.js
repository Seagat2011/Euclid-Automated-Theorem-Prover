                ...
                if(
                    ...
                    if(solutionComplete){
                        if(stack.length){
                            ...
                            var s2 = u.indir.match(/Optimal/) ? stackR.collapseRedundantPaths().join('<br><br>') : stack.join('<br><br>') ;
                            self._solutionEditor.appendlog(s1)
                            self._solutionEditorR.invalidate=false
                            self._solutionEditorR.appendlog(s2)
                            stackR = []
                            stack = []
                        }
                        ...
                        Boolean(u.indir.match(/Expand|Auto|Optimal/)) &&
                        postMessage({
                            source:self._guid,
                            Proof:P,
                            indir:u.indir,
            ...
            if(
                ...
                if(
                    ...
                    if(solutionComplete){
                        ...
                        Boolean(u.indir.match(/Reduce|Auto|Optimal/)) &&
                        postMessage({
                            source:self._guid,
                            Proof:P,
                            indir:u.indir,
